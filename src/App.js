            ...
            <Routes>
              ...
              <Route path="/" element={<DefaultLayout />}>
                ...
                <Route
                  ...
                  element={<ServiceDetail serviceTitle="Dịch vụ chuyển phát tiêu chuẩn" serviceSubtitle="TKT Express" />}
                />
                <Route path="dich-vu-nhanh" element={<ServiceDetail serviceTitle="Dịch vụ Nhanh" serviceSubtitle="TKT Fast" />} />
                <Route
                  path="sieu-dich-vu-giao-hang"
                  element={<ServiceDetail serviceTitle="Siêu dịch vụ giao hàng" serviceSubtitle="TKT Super" />}
                />
                <Route
                  path="dich-vu-tuoi-song"
                  element={<ServiceDetail serviceTitle="Dịch vụ tươi sống" serviceSubtitle="TKT Fresh" />}
                />
                <Route
                  path="tuyen-van-chuyen-quoc-te"
                  element={<ServiceDetail serviceTitle="Tuyến vận chuyển quốc tế" serviceSubtitle="TKT International" />}
                />
                {/* ----------------------Profile------------------ */}
